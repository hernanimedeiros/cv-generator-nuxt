<template>
  ...
  <section class="about-layout w-100">
    <b-button class="floating-button-side-lang bg-transparent border-0 shadow-none">
      <LanguageSet
        v-once
        :content="content"
...
<style>
  ...
  *::after {
  ...
  .floating-button-side-lang:hover {
    border:none;
    background: transparent;
    transform: scale(1.1);
    opacity: 1;
